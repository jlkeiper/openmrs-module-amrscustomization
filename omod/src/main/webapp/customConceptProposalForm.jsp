...
<c:if test="${fn:length(matchingProposals) > 1}">
	<spring:message code="ConceptProposal.update.note" arguments="${fn:length(matchingProposals)-1}"/><c:if test="${fn:length(matchingProposals) > 2}"><spring:message code="ConceptProposal.update.note.plural"/></c:if>
	<br/>
</c:if>
<br />

...
import org.openmrs.module.amrscustomization.hl7.PrioritizedHL7InQueueProcessor;
 ...
 */
public class ProcessPrioritizedHL7InQueueTask extends AbstractTask {

	// Logger
	private static Log log = LogFactory.getLog(ProcessHL7InQueueTask.class);

	// Instance of hl7 processor
	private static PrioritizedHL7InQueueProcessor processor = null;

	/**
	 * Default Constructor (Uses SchedulerConstants.username and SchedulerConstants.password
	 */
	public ProcessPrioritizedHL7InQueueTask() {
		if (processor == null) {
			processor = new PrioritizedHL7InQueueProcessor();
		}
	}

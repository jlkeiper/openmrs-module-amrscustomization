 ...
 * @author jkeiper
 */
public class FormsHotlist extends Extension {
	...
	public String getOverrideContent(String bodyContent) {
		...
		modelMap.put("months", Context.getAdministrationService()
	...
	protected String renderHTML(String templateName, Map<String, Object> modelMap) {
		...
		URL url = c.getResource(AMRSCustomizationConstants.VELOCITY_TEMPLATE_FOLDER);
		if (url == null) {
			String err = "Could not open resource folder directory: "
					+ AMRSCustomizationConstants.VELOCITY_TEMPLATE_FOLDER;
			log.error(err);
